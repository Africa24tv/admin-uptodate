...
<h1 class="text-xl">Création d'un article</h1>
    <form action="{{ route('articles.store') }}" method="POST" encType="multipart/form-data">
        ...
        <div class="bg-white block m-3 space-y-2 rounded-md shadow-sm p-2">
            ...
            <hr />
            <select
                class="w-full border-gray-700 rounded-md focus:outline-none"
                id="type"
                name="type"
                onChange={changeType}
                >
        ...
        <div class="bg-white block m-3 space-y-2 rounded-md shadow-sm p-2">
            ...
            <hr />
            <input class="outline-none font-bold w-full p-3" type="number" id="media" name="media" placeholder="ex:[0000000001]"/>
        </div>
        ...
        <a  class="bg-blue-300 hover:bg-blue-100 shadow-sm rounded-lg px-2 transition duration-400 w-1/6 content-center py-2 m-5 font-bold text-white hover:text-gray-500">
        ...
        function markdown() {
            return {
                ...
                convertedMarkdown() {
                    ...
                    this.convertedContent = marked(this.content, { sanitize: false });
                },
                convertHtmlToMarkdown() {
