...
<div class="main-content flex-1 bg-gray-100 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="bg-gray-100 pt-3">
                    <div class=" bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                        <h3 class="font-bold pl-2">SERVICES</h3>
                    </div>
                </div>
                        ...
                        <div
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h5 class="font-bold uppercase text-gray-600">Visite</h5>
                                    <h3 class="font-bold text-3xl"> 3 <span class="text-green-500"><i
                                                class="fas fa-post"></i></span></h3>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                        ...
                        <div
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    ...
                                    <h3 class="font-bold text-3xl">{{ $nbre_users }}</span></h3>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h5 class="font-bold uppercase text-gray-600">Articles</h5>
                                    <h3 class="font-bold text-3xl">{{ $nbre_articles }} <span class="text-yellow-600"><i
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h5 class="font-bold uppercase text-gray-600">Tâches</h5>
                                    <h3 class="font-bold text-3xl">{{ $nbre_taches }}</h3>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h5 class="font-bold uppercase text-gray-600">Évènements</h5>
                                    <h3 class="font-bold text-3xl">{{ $nbre_events }} <span class="text-red-500"><i
                                                class="fas fa-caret-up"></i></span></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-full md:w-1/2 p-6">
                        ...
                        <div class="bg-white border-transparent rounded-lg shadow-xl">
                            <div
                                ...
                                <h5 class="font-bold uppercase text-gray-600">Productivité</h5>
                            </div>
                            <div class="p-5"><canvas id="chartjs-4" class="chartjs" width="undefined"
                                ...
                                <script>
                                    new Chart(document.getElementById("chartjs-4"), {
                                        "type": "doughnut",
                                        "data": {
                                            "labels": ["Inactifs", "Production totale"],
                                            "datasets": [{
                                                "label": "Issues",
                                                "data": [100-{{ $prod_totale }}, {{ $prod_totale }}],
                                                "backgroundColor": ["rgb(255, 250, 250)", "rgb(54, 162, 235)"]
                                            }]
                                        }
                                    });
                                </script>
